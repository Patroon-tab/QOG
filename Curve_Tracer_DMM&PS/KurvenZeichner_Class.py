...
class MyGui:
    ...
    def testcon(self):
        ...
        button = Button(self.testwindow, text = "Ping DMM1",width = 14, command = lambda: self.getdmm(self.dmm1com.get(), dmm1show))
        button.grid(column = 2, row = 3, sticky = "e")
        
        button = Button(self.testwindow, text = "Ping DMM2",width = 14, command = lambda: self.getdmm(self.dmm2com.get(), dmm2show))
    ...
    def measure(self):
        ...
        serps = initialiseps(self.pscom.get())
        setvoltage(serps, 0)
        
        time.sleep(2)
        
        if xdevice == "DMM1" or ydevice == "DMM1":
            serdmm1 = initialisedmm(self.dmm1com.get())
        if xdevice == "DMM2" or ydevice == "DMM2":
            serdmm2 = initialisedmm(self.dmm2com.get())    
