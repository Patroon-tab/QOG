...
def initalise(com):
    ...
    try:
        ...
        ser = serial.Serial()
        ser = serial.Serial(com, baudrate=2400, bytesize=serial.EIGHTBITS, parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE, timeout=0.1, rtscts=False, dsrdtr=True)
        ser.setRTS(0)
        ser.setDTR(1)
        ser.setDTR(0)
